...
namespace TourOfHeroesRepository.Repository.DAO
{
    public static class MappingExtensions
    {
        ...
        public static HeroDao ToDao(this HeroDto entity) => new HeroDao(entity.HeroId, entity.Name, entity.PowerTypeId, entity.Popularity, entity.Strength, entity.LastUpdate);
